...
async function getRedis() {
  ...
  try {
    ...
    if (!apiUrl || !apiToken) {
      console.warn('⚠️ Vercel KV not configured - Missing API URL or TOKEN');
      console.warn('   Checked: KV_REST_API_URL, REDIS_KV_REST_API_URL');
      console.warn('   Checked: KV_REST_API_TOKEN, REDIS_KV_REST_API_TOKEN');
